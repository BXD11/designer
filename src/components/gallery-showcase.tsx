...
const mockWorks: DesignWork[] = [
  ...
  {
    id: '2',
    title: 'ثامبنيل قناة يوتيوب تقنية',
    description: 'تصميم ثامبنيل احترافي لقناة يوتيوب',
    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h2 className="text-3xl font-bold gradient-text">معرض الأعمال</h2>
          <Button
            variant="ghost"
            size="icon"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <AnimatePresence mode="wait">
          {mockWorks.map((work, index) => (
            ...
            >
              {/* Holographic Background for Featured */}
